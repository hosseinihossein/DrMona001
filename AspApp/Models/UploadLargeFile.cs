...
public class UploadLargeFile
{
    ...
    public UploadLargeFile(IWebHostEnvironment _env, FileNameValidator fileNameValidator)
    {
        env = _env;
    ...
    T? formModel, List<string> uploadingFormFileNames, ControllerBase controllerBase) where T : class
    {
        ...
        catch (Exception e)
        {
            ...
            uploadLargeFile_Model.ErrorDescription.Add(e.Source ?? "exception", e.Message);
            return uploadLargeFile_Model;
        }
